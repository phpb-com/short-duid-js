...
describe('Short DUID', function () {
  ...
  describe('DUID with drifting time', function () {
    ...
    var id1 = BigInt(duid_instance3.getDUIDInt(1)[0]);
    var drift = duid_instance3.driftTime(Math.random() * 1000 * 10 * -1 || 0);
    var id2 = BigInt(duid_instance3.getDUIDInt(4096)[4095]); //Need to rollover sequence
    var curr_ms_time = BigInt(duid_instance3.getCurrentTimeMs());
